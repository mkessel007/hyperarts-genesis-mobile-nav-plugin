...
function ha_genesis_mobile_nav_register_scripts() {
	...
	wp_register_style( 'ha-mobile-nav', plugins_url() . '/hyperarts-genesis-mobile-nav/mobile-nav.css', array(), '1.0.0' );
	wp_register_script( 'ha-mobile-nav', plugins_url() . '/hyperarts-genesis-mobile-nav/mobile-nav.js', array( 'jquery' ), '1.0.0', true);
}
